  ...
  return (
    <>
      <Project state={project1.state} github={project1.github} url={project1.url}>
        <div className="max-sm:px-0 py-2 w-full">
          <div className="mb-4 w-full">
            <TypographyH2 text={project1.title} className="pb-2 font-extrabold text-blue-400 text-2xl" />
      ...
      <Project state={project2.state} github={project2.github} url={project2.url}>
        <div className="max-sm:px-0 py-2 w-full">
          <div className="mb-4 w-full">
            <TypographyH2 text={project2.title} className="pb-2 font-extrabold text-blue-400 text-2xl" />
      ...
      <Project state={project3.state} github={project3.github} url={project3.url}>
        <div className="max-sm:px-0 py-2 w-full">
          <div className="mb-4 w-full">
            <TypographyH2 text={project3.title} className="pb-2 font-extrabold text-blue-400 text-2xl" />
      ...
      <Project state={project4.state} github={project4.github} url={project4.url}>
        <div className="max-sm:px-0 py-2 w-full">
          <div className="mb-4 w-full">
            <TypographyH2 text={project4.title} className="pb-2 font-extrabold text-blue-400 text-2xl" />
